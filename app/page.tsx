        ...
        <main className="main-panel">
          <div className="workspace-header">
            <div>
              ...
              <h1 className="page-title">題材靈感工作台</h1>
...
.btn-script{font-size:10px;font-weight:500;letter-spacing:0.06em;text-transform:uppercase;padding:7px 12px;background:none;border:1px solid rgba(255,255,255,0.14);color:var(--text2);border-radius:12px;cursor:pointer;text-decoration:none;transition:all 0.15s}
